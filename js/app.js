...
async function shareRulesAndText(a){
  ...
  // Abre sempre a conversa da cliente diretamente. Navegadores/PWAs não conseguem
  // anexar um arquivo e, ao mesmo tempo, impor um destinatário ao compartilhamento nativo.
